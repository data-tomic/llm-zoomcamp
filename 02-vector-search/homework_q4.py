...
similarities_q4 = [
    np.dot(query_embedding, doc_emb) for doc_emb in full_text_embeddings_q4
]
...
print(
    f"Index of document with highest similarity for Q4 (full_text): {highest_similarity_index_q4}"
)
